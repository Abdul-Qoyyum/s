  ...
  <body>
    ...
    <main>
      <table>
        ...
        <tbody>
          <tr>
            <td class="service">{{$quote->name}}</td>
            <td class="desc">{!! $quote->description !!}</td>
            <td class="unit">${{$quote->total}}</td>
          ...
          <tr>
            ...
            <td class="grand total">${{$quote->total}}</td>
          </tr>
        </tbody>
      </table>
      <div id="notices">
