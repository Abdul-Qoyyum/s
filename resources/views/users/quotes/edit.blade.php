...
{!! Form::model($quote,['route' => ['quote.update',$quote->id],'method' => 'PATCH']) !!}
          ...
          <div class="row">
              ...
              <div class="card shadow mb-4">
                <div class="card-body">
                    <div class="form-group row">
                        <label for="quote_id" class="col-sm-4 col-form-label">Quote ID</label>
                        <div class="col-sm-6">
                        <input type="text" class="form-control" name="quote_id"  id="quote_id" value="{{Str::replaceArray('-',['',''],\Carbon\Carbon::now()->toDateString())}}">
                        </div>
                    </div>
                    <div class="form-group row">
            ...
            <div class="card shadow mb-4">
                <div class="card-body">
                    ...
                    {!! Form::textarea('body', null, ['class'=>'form-control','placeholder'=>"E.g. Thank you for considering me as your photographer! Please choose from the list of packages and products and click Accept. Don't hestitate to contact me if you have any questions." ]) !!}
                </div>
            </div>
     ...
     <hr>
      ...
      <hr>                  
                  <div class="container">
                    ...
                    {!! Form::textarea('notes', null, ['class'=>'form-control','placeholder'=>'These are additional notes you wish to add to your quote']) !!}
                  </div>


<hr>
                  <div class="row justify-content-between" style="background-color: #ccc;padding:15px;">
                      <div class="col-md-4 mb-2"><h5><strong>Do you want to assign a payment schedule to this quote?</strong></h5></div>
