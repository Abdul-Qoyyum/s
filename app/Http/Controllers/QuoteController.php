...
class QuoteController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $package = Package::findOrFail($request->package_id);
            ...
            $invoice = Quotes::create($invoiceDetails);
    ...
    public function show($id)
    {
        ...
        $task = $quote->task;
        $client = $task->client;
        return view('users.quotes.show',compact('user','quote','task','client'));
    }
...
//      Options
        ...
        return view('users.quotes.edit',compact('task','packages','taxes','contracts','client','job','workflow','questionaires','quote','paymentSchedules'));
    ...
    public function update(Request $request, $id)
    {
        ...
        if($package){
           $name =  ['name' => $package->name,]; //change package name if only it exists
            ...
            // update the quote resource
            $quote = Quotes::where('id',$id)->update($quoteDetails);
    ...
    /**
     * Show the create quote form for specific task
     * 
     * @param int $id
     * @return \Illuminate\Http\Response
     */
...
//      Options
        ...
        $contracts = $this->getContracts();
        $questionaires = $this->getQuestionaires();
        return view('users.quotes.create',compact('task','packages','taxes','contracts','client','job','workflow','questionaires'));
    }
    ...
    public function preview($id){
        ...
        $task = $quote->task;
        $client = $task->client;
        $view = view('users.quotes.quote',compact('user','task','client','quote'))->render();
    ...
    public function downloadPDF($id){
        ...
        return $pdf->download("quote-$time.pdf");
    }
